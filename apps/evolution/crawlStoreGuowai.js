...
const getTaskApi = crawltaskConfig.getUrl.guowai;
const saveTaskApi = crawltaskConfig.postUrl.guowai;
                    ...
                    (async () => {
                        try {
                            if (error) {
                                ...
                                fun.stoneLog('crawlMainGuowai', 'error', {
                                    "param1": _this.taskId,
                                    "param2": taskUrl,
                                ...
                                fun.stoneLog('crawlMainGuowai', 'trace', {
                                    "param1": _this.taskId,
                                    "param2": taskUrl,
                                    "param": {"message": '抓取完成'}
                                })
