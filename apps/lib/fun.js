...
exports.getStore = function (urlStr) {
    var store = [
        ...
        {name:'eastbay',  regexp: ['eastbay']},
        {name:'finishline',  regexp: ['finishline']},
        {name:'flightclub',  regexp: ['flightclub']},
        {name:'goat',  regexp: ['goat']},
        {name:'overkillshop',  regexp: ['overkillshop']},
