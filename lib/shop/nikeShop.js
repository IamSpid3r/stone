...
function getItemInfo(params, callback){
    ...
    //var apiUrl = 'https://m.nike.com/mobile-services/gridwallData?gridwallPath='+gridwallPath+'&country=CN&lang_locale=zh_CN&ipp=24&pn='+page+'&pageNumber='+page+'&cache=true';
...
console.log(apiUrl)
    proxyRequest({
        url: apiUrl,
        headers: { 'User-Agent' : 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/66.0.3359.181 Safari/537.36'}
    },function(err, body){
        if(err){
            callback(err);
            return ;
        ...
        // }
        urls.push('https://store.nike.com/html-services/gridwallData?country=CN&lang_locale=zh_CN&gridwallPath=%E5%A5%B3%E5%AD%90-%E9%9E%8B%E7%B1%BB/7ptZoi3&pn='+page);
