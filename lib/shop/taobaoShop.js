...
function getItemInfo(params, callback){
    ...
    var apiUrl = 'https://xmofs.m.tmall.com/shop/shop_auction_search.do?spm=a320p.7692171.0.0' +
        '&suid='+userId+'&sort=s&p=1&page_size=12&from=h5&shop_id='+shopId+'&ajson=1&_tm_source=tmallsearch&callback=json';
    ...
    proxyRequest({
        ...
        var totalPage = text.total_page;
        totalPage = totalPage > 20 ? 20 : totalPage;
        var urls = [];
        for(var i=2; i<=totalPage; i++){
            urls.push('https://xmofs.m.tmall.com/shop/shop_auction_search.do?spm=a320p.7692171.0.0' +
            '&suid='+userId+'&sort=s&p='+i+'&page_size=12&from=h5&shop_id='+shopId+'&ajson=1&_tm_source=tmallsearch&callback=json');
        }
        ...
        ep.after('currentUrls', urls.length, function (currentItems) {
            ...
            currentItems.forEach(function(currentItem){
                currentItem.items.forEach(function(item) {
                    items.push({
...
function proxyRequest(options, callback){
    options.headers = {
        'refer': 'https://auxdq.m.tmall.com/shop/shop_auction_search.htm?spm=a320p.7692171.0.0&suid=1035757927&sort=d',
        "Accept":'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8',
        "Accept-Encoding":"deflate, sdch",
        "Accept-Language":"zh-CN,zh;q=0.8",
        "cookie":"cna=fR+hDeeT50ICATr3cloaZbmD; miid=6345998908287345826; x=e%3D1%26p%3D*%26s%3D0%26c%3D0%26f%3D0%26g%3D0%26t%3D0%26__ll%3D-1%26_ato%3D0; lzstat_uv=8629291913329613887|2144678; tracknick=hxl724753832; _cc_=VT5L2FSpdA%3D%3D; tg=0; thw=cn; v=0; cookie2=1c7bbf9e1215cb87b08ec21f399c6498; t=17cb7c33aba0dc662a5d8eb53fdf6401; uc1=cookie14=UoWxMPWZEssQOQ%3D%3D; _tb_token_=qJoDmUMIJFXz9c3; mt=ci%3D-1_0; l=Ajg4Vmc1KX4VL9QVWo/j-16oiOjKoZwr"
    };
