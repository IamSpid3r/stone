...
exports.getInfo = function (urlStr, callback) {
    ...
    if (urlInfo.host == 'cn.kiwidiscovery.co.nz') {
...
function getItemInfo(params, callback) {
    ...
    var price = $('.DetailPrice').find('div').text();
    if (price) {
        price = price.replace('NZ$', '').trim();
    }
    var img = $('.product-image').find('img').attr('src');
    ...
    var itemInfo = {
        ...
        ItemAttributes: {
            Title: title,
            ShopName: 'kiwidiscovery',
            ShopId: 'cn.kiwidiscovery.co.nz',
            ImageUrl: img,
            Tax: 1
        },
        Variations: [],
