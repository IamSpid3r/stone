...
function getItemInfo(params, callback) {
    ...
    try {
        ...
        var shopId = $('.btn-collect').attr('data-product-id')
        var url = 'https://www.ba.de/api/products/promotion?id=' + shopId;
        getStatus(url, itemInfo, callback).then(function () {
            // 数据加密
...
//获取是否缺货
function getStatus(url, itemInfo, callback) {
    var defer = Q.defer();
