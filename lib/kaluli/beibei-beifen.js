...
function getItemInfo(params, callback) {
    ...
    var typeLength = variations.length
    var zz = JSON.stringify(stockMap)
    // console.log(stockMap)
    for(var iii in stockMap){
        console.log(stockMap[iii])
    }
    console.log()
    // var zz = []
    // variations.forEach(function (variationsItem) {
    //     var asd = variationsItem.Values.length
    //     zz.push(asd)
    // })
    // var sun = '1'
                    ...
                    "List": [
                        {
                            ...
                            "Price": stockMap[NidAll].price / 100,
                            "Type": "RMB"
                        }
                    ]
                }];
