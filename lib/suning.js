...
exports.getInfo = function(urlStr, callback) {
    ...
    var m_url ="http://pas.suning.com/nssnitemsale_000000000"+pid+"_"+sid+"_20_021_0210101_0_5__999__.html?callback=wapData";
    //get html
...
function getItemInfo(params, callback) {
    ...
    priceSkusArr.forEach(function (priceSkuP,key) {
        getHtml('http://icps.suning.com/icps-web/getVarnishAllPrice014/'+priceSkuP.join(',')+'_021_0210901_'+priceSidArr[key].join(',')+'_1_getClusterPrice.vhtm?callback=getClusterPrice', function(bodyPrices, err){
            if(err){
                callback({
                    "Errors":{
                        'Code': 'Error',
    ...
    if (colorSkus){
        colorSkus.forEach(function (colorSku) {
            var wap_url ="http://pas.suning.com/nssnitemsale_"+colorSku.skuid+"_"+sid+"_20_021_0210101_0_5__999__.html?callback=wapData";
