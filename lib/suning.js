...
function getItemInfo(params, callback) {
    ...
    if ( body.data.data1.code == 2 && typeof body.data.data1.data.itemInfoVo == 'undefined') {
        itemInfo.Status = 'notFind'
        itemInfo.Md5 = md5(JSON.stringify(itemInfo));
        return callback(null, itemInfo);
    }
    ...
    itemInfo.ItemAttributes.ImageUrl =   'http://image3.suning.cn/uimg/b2c/newcatentries/'+sid+'-'+body.data.data1.data.partNumber+'_1.jpg';
