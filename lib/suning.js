...
function getItemInfo(params, callback) {
    ...
    itemInfo.ItemAttributes.ShopName = '苏宁易购';
    ...
    if (itemType == 0){
        ...
        getHtml(p_url, function(body, err){
            ...
            getHtml("https://pas.suning.com/nsendetail_000000000"+pid+"_"+sid+"_021_0210199_5_R1901001_10051_77518.00_0_20_C_ZE99_"+sid+"_77581.00_0_"+pid+"_999_0_0021__000060021_20006_3_0__CH9F0_1000267_6071634739____.html", function(body, err){
                if(err){
                    callback({
                        "Errors":{
                            'Code': 'Error',
                ...
                try{
                    ...
                    itemInfo.Items[0].Subtitle = Subtitle;
                }catch(e){
                    console.log(e)
                    // callback(null, itemInfo);
                    // return '';
         ...
         ep.after('priceSkus', length, function (priceSkusItems) {
            priceSkusItems.forEach(function(priceSkusItem){
                if (priceSkusItem[0] == 'price'){
                    ...
                    if (priceSkusItem[1].data.salesPromotion.activityList.length>0){
                            itemInfo.Coupon = {"List": []};
