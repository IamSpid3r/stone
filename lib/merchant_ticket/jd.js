...
exports.getInfo = function(urlstr, callback) {
    ...
    var itemIdReg = /(\d*)\.html/;
    var itemIdRes = itemIdReg.exec(urlstr);
    if (/(jd)\.com/.exec(urlInfo.host) && itemIdRes) {
        getItemInfo(urlstr, itemIdRes[1], callback);
    } else {
        callback({
            "Errors":{
                'Code': 'Fatal',
