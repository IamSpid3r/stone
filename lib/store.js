...
const sephora = require(process.cwd()+'/lib/sephora');
const bolo = require(process.cwd()+'/lib/bolo');
const jumei = require(process.cwd()+'/lib/jumei');
const xiaohongshu = require(process.cwd()+'/lib/xiaohongshu');
