...
const taobaoV3 = require(process.cwd()+'/lib/taobaoV3');
...
const stockx = require(process.cwd() + '/lib/stockx');//stockx
const eastbay = require(process.cwd() + '/lib/eastbay');//eastbay
const finishline = require(process.cwd() + '/lib/finishline');//finishline
...
const feelunique = require(process.cwd()+'/lib/kaluli/feelunique'); //欧洲直邮
const dokodemo = require(process.cwd()+'/lib/kaluli/dokodemo'); //日本直邮
const rakuten = require(process.cwd()+'/lib/kaluli/rakuten'); //日本直邮
const gmarket = require(process.cwd()+'/lib/kaluli/gmarket'); //韩国直邮

const flightclub = require(process.cwd() + '/lib/flightclub');
const goat = require(process.cwd() + '/lib/goat');
const overkillshop = require(process.cwd() + '/lib/overKillShop');

const fun = require(process.cwd() + "/apps/lib/fun.js");
//获取商城对象
exports.getStore = function (urlStr) {
    var store = [
        {object: [taobaoV2, taobaoV3] , regexp: 'item.taobao.com'},
        {object: [taobaoV2, taobaoV3] , regexp: ['tmall.com', 'detail.tmall.hk']},
        ...
        {object: shihuoHaitao , regexp: ['www.shihuo.cn\/xianhuo', 'haitaodashi']},
        ...
        {object: du , regexp: ['du.hupu.com', 'm.poizon.com']},
        ...
        {object: stockx , regexp: ['stockx.com']},
        ...
        {object: feelunique , regexp: ['cn.feelunique.com']},
        {object: dokodemo , regexp: ['dokodemo.world']},
        {object: rakuten , regexp: ['global.rakuten.com']},
        {object: gmarket , regexp: ['item2.gmarket.co.kr']},
        {object: eastbay , regexp: ['eastbay.com']},
        {object: finishline , regexp: ['finishline.com']},
        {object: flightclub, regexp: ['flightclub.com']},
        {object: goat, regexp: ['goat.com']},
        {object: overkillshop, regexp: ['overkillshop.com']},
    ];
    ...
    if (index === null) {
        ...
        if (Array.isArray(store[index].object)) {
            let rnd = fun.rnd(0, store[index].object.length);
            return  store[index].object[rnd];
        } else {
