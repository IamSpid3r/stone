...
function getItemInfo(params, urlInfo, callback) {
    ...
    var getStageInfo = function (apiUrl) {
        getHtml(apiUrl, function (body, err) {
            if (!err) {
                try {
                    ...
                    console.log('getStageInfo:' + e.message);
                    event.emit('crawl_ok', {
                        "Errors": {
                            'Code': 'Error',
                            "Message": 'getStageInfo' + e.message
                        }
                    });
                }
            } else {
                event.emit('crawl_ok', {
                    "Errors": {
                        'Code': 'Error',
                        "Message": 'getStageInfo' + err.message
                    }
                });
            }
        })
