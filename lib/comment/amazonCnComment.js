...
function getItemInfo(urlStr, asin, callback){
    var commentUrl = 'http://www.amazon.cn/product-reviews/'+asin+'?ie=UTF8&showViewpoints=1&sortBy=recent&pageNumber=1'
    ...
    proxyRequest({
        ...
        for(var i= 1;i <= page;i++){
            urls.push('http://www.amazon.cn/product-reviews/'+asin+'?ie=UTF8&showViewpoints=1&sortBy=recent&pageNumber='+i);
        }
