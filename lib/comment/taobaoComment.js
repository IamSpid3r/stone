...
function getItemInfo(urlInfo, callback){
    proxyRequest({
        ...
        //抓取
        console.log('https://rate.taobao.com/feedRateList.htm?auctionNumId='+urlInfo.query.id+'&userNumId='+res1[2]+'&currentPageNum=1&pageSize=20&orderType=feedbackdate&showContent=1&rateType=3');
        proxyRequest({
