...
//     })
    ...
    function getItemInfo(urlInfo, callback) {
        proxyRequest({
            ...
            //      if(!error){
            //          priceSkuList = {};
            //          iteremInfo2.Items.forEach(function (val) {
...
function getItemInfo(urlInfo, callback) {
    ...
    proxyRequest({
        ...
        if (responseFirstJson.data.seller.type == 'B') {
            pageUrl = 'https://detail.m.tmall.com/item.htm?id=' + urlInfo.query.id + '&t=' + new Date().getTime();
            ...
            proxyRequest({
                ...
                var body = iconv.decode(new Buffer(body), "GBK");
