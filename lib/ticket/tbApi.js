 ...
 * @Date:   2017-05-13T21:58:37+08:00
 * @Last modified by:   songxiaoqiang
 * @Last modified time: 2017-06-13T16:43:56+08:00
 */


/**
 * [淘宝api]
 * @param  {[string]} globalCookies [从客户端获取的淘宝cookie]
 * @return {[object]}               [返回带有淘宝类库的对象]
 */
module.exports = (globalCookies)=>{
  var location = {
      "hash": "",
