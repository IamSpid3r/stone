...
exports.getInfo = function(urlStr, callback) {
    ...
    prodAdv.call("ItemLookup", {
        ...
        var itemInfo = {
            ...
            Md5: '',
            Status: '',
            Url: 'http://www.amazon.cn/gp/product/' + asin + '/',
            ItemAttributes: {
                Title: ''
            },
            Variations: [],
        ...
        if('Errors' in ProductOriginalData.Items.Request)
        {
            if(ProductOriginalData.Items.Request.Errors.Error.Message.indexOf('is not a valid value for ItemId') > 0)
            {
                ...
                callback('error :'+ProductOriginalData.Items.Request.Errors.Error.Message)
            }
            return;
        }
        callback(null, {'itemInfo':itemInfo,'ProductOriginalData':ProductOriginalData});
    })
}
