...
exports.getInfo = function(urlStr, callback) {
    ...
    getParentAsin(asin).then(function(parentAsin) {
                ...
                for (var j = 0; j < amzItem.VariationAttributes[0].VariationAttribute.length; j++) {
                    ...
                    if (index == -1) {
                        ...
                        if (itemAttr.Name == 'Color') {
                            newAttr.Values[0].ImageUrl = amzItem.LargeImage[0].URL;
                        }
                        ...
                        if (nameIndex == -1) {
                            var newAttrValue = {
                                ValueId: (itemInfo.Variations[index].Id) * 1000 + (itemInfo.Variations[index].Values.length),
                                Name: itemAttr.Value[0]
                            };
                            if (itemAttr.Name == 'Color') {
                                newAttrValue.ImageUrl = amzItem.LargeImage[0].URL;
                            }
...
var proxyRequest = function(options, testCallback, callback) {
    ...
    // options.proxy = 'http://121.233.255.139:7777';
